...
clusterings_results_path = 'C:\\Users\\anton\\Chicks_Onset_Detection_project\\Results_Clustering\\_fuzzy_clustering_8'
...
# Give a unique call_id to each row
all_data['call_id'] = all_data['recording'].str.split('_').str[0] + '_' + all_data['onsets_sec'].astype(str)
print('Unique call_id created')
...
n_clusters = 3  # best number of clusters from the elbow rule with wcss
...
custom_colors = ["darkorange", "turquoise",  'violet','LightCoral', 'MediumSlateBlue', 'ForestGreen', 'DarkTurquoise', 'DarkRed', 'DarkOrange', 'DarkGreen', 'DarkBlue', 'DarkViolet', 'DarkGray']
